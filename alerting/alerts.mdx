---
title: "Alerts: raise an incident from monitor results"
description: >-
  Configure threshold, success rate, and raw alerts on monitoring data to
  trigger incidents and notify your team via email, Slack, or webhooks.
sidebarTitle: "Alerts"
---

Monitors produce a stream of results; alerts decide which of them deserve your attention. An alert watches monitoring data, raises an [incident](/alerting/incidents) when its conditions are met, and notifies your team through the channels you choose. You manage them on the **Alerts** tab of the Incidents area.

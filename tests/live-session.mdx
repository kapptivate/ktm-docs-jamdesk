...
![A SIM session with the action dropdown open, listing the USSD, SMS, Data, and Call actions](/images/live-session-sim-actions.webp)
...
![The Send SMS form with access technology, destination number, message, delivery report, and SMSC options](/images/live-session-sim-sms.webp)
...
![A live smartphone session with the mirrored screen, the Information panel, the Control Panel, and Quick Access buttons](/images/live-session-smartphone.webp)
...
![The XML Viewer with the element tree on the left and the highlighted screenshot preview on the right](/images/live-session-xml-viewer.webp)
...
![A web agent session with the action dropdown and the API Call configuration options](/images/live-session-web-api-call.webp)
...
![The History tab with the Creator and Resource filters, logged Wait SMS actions with results, and the Action List panel](/images/live-session-history.webp)

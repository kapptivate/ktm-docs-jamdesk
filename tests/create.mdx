...
Once you create the test, the editor opens. You are ready to add steps that define the test's actions. See [Test steps](/tests/steps) to learn the available step types for your channel.

## What's Next?

<Columns cols={2}>
  <Card title="Test steps" icon="list-check" href="/tests/steps">
    Add clicks, taps, checks, and other actions to your test.
  </Card>
  <Card title="Configurations" icon="code" href="/tests/configurations">
    Use variables to parameterize tests and switch environments.
  </Card>
</Columns>

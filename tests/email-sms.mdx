...
<Columns cols={2}>
  ...
  <Card title="Get email code reference" icon="envelope" href="/tests/actions/shared/aigetmailcode">

    Parameters and JSON format for the email code step

</Card>
  <Card title="Get sms code reference" icon="comment-sms" href="/tests/actions/shared/aigetsmscode">

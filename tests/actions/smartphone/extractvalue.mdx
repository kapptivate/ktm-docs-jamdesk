---
title: "Extract value in a smartphone test"
sidebarTitle: "Extract value"
description: "Capture data from the app into a variable: an order number to verify, a price to compare, a generated ID to type into another form."
---

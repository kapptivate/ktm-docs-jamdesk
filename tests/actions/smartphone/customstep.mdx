---
title: "Run your own JavaScript in a smartphone test"
sidebarTitle: "Custom step"
description: "Run your own JavaScript in a smartphone test when no built-in step fits: an uncovered flow, a computed value, a custom metric sent to Analytics."
---

---
title: "Verify element in a smartphone test"
sidebarTitle: "Verify element"
description: "Check that an element of the app is, or is not, displayed, clickable, enabled, or present, and fail the smartphone test when it is not."
---

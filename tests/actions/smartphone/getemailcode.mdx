---
title: "Get email code in a smartphone test"
sidebarTitle: "Get email code"
description: "Test an email verification flow on a device end to end: the step watches a test mailbox, waits for the email, and extracts the code with AI."
---

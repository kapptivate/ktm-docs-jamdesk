---
title: "Fill input in a smartphone test"
sidebarTitle: "Fill input"
description: "Type text into a field of the app. The value can mix fixed text, variables, and generated data, so one step logs in or signs up."
---

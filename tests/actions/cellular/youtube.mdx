...
|-----------|------------|----------|-------------|
| Url | `command.url` | Yes | The video URL to stream. |
| Quality | `command.quality` | No | Requested video quality. Default: `144p`. |
| Duration to play | `command.duration_to_play` | No | How long to stream, in seconds. Default: 10. |

---
title: "Fill input in a web test"
sidebarTitle: "Fill input"
description: "Type text into a field on the page. The value can mix fixed text, variables, and generated data, so one step logs in or signs up."
---

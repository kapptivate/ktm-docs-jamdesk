---
title: "Assert not displayed in a web test"
sidebarTitle: "Assert not displayed"
description: "Legacy step that verifies an element is hidden or absent from the page. Use Verify element in a web test instead."
---

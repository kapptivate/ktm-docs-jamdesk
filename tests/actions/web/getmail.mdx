---
title: "Get mail in a web test"
sidebarTitle: "Get mail"
description: "Verify that your application really sends an email. The step waits for it to land in a test mailbox and fails if nothing arrives in time."
---

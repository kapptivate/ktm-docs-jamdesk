---
title: "Get email code in a web test"
sidebarTitle: "Get email code"
description: "Test an email verification flow on the web end to end: the step watches a test mailbox, waits for the email, and extracts the code with AI."
---

---
title: "Wait for delay in a web test"
sidebarTitle: "Wait for delay"
description: "Pause a web test for a fixed duration, when nothing observable signals readiness: a backend job, a rate limit, an animation."
---

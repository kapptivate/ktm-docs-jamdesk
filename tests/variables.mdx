...
The **Set variable** step stores a value of your own mid-test: give it a value and a name, and it appears in the Previous steps tab for every later step. See the [Set variable reference](/tests/actions/shared/setvariable) for the JSON format and template functions.
...
![The Random tab of the variable picker with its presets](/images/variables-random.webp)
...
![The Custom format dialog generating a date, with the format dropdown open](/images/variables-custom-format.webp)
...
![The Environment tab listing test variables and masked global variables](/images/variables-environment.webp)

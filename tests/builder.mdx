...
![The Kompagnon recorder widget capturing actions live on the target site](/images/builder-web-recorder.webp)
...
![Assertion mode in the recorder widget, selecting an element to verify](/images/builder-recorder-assert.webp)
...
![The Add step menu with its searchable action categories](/images/builder-step-menu.webp)
...
![The step group menu with Move, Duplicate, Create reusable component, and Delete actions](/images/builder-group-menu.webp)
...
![A smartphone step with its reference screenshot and selector](/images/builder-smartphone-reference.webp)
...
![The Advanced settings tab with execution settings and interval](/images/builder-step-advanced.webp)
...
![Per-step AI usage with the Smart and Always strategies](/images/builder-step-ai.webp)
...
![Test settings with Delays & timeouts and Hooks expanded](/images/builder-test-settings.webp)
...
![The Reusable steps group library, picking a component for a hook](/images/builder-component-library.webp)

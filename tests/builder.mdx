...
- **Advanced**: the test's default [execution mode](/executions/execution-modes) (how much data each run collects), accepting non-secure certificates, and custom capabilities

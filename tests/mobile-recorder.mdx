...
- **Assertion mode** turns your next tap into a check rather than an action: you point at what should be on the screen and the recorder writes a **Verify element** step.

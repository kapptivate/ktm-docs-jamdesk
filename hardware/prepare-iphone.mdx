...
<Note>
  Stand the iPhone up on a holder once it's plugged in. A phone on a robot charges around the clock, and air moving behind the case delays [the day its battery swells](/hardware/swap-battery#smartphone-batteries-swelling).
</Note>

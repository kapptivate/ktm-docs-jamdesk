...
Point any MCP-compatible client at `https://mcp.kapptivate.com/mcp` and authenticate with the `X-Kapptivate-API-Key` header. This page covers the common developer clients (Claude, Cursor, Claude Code). For Microsoft 365 Copilot Studio and Google Gemini, see their dedicated pages in this section.

...
```text
Add a new variant (environment slice) to a variable group. If is_default=true the prior default is demoted in the same atomic update. The backend auto-fans new variants into existing variables in the group.
```

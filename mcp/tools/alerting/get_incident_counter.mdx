...
```text
Get a quick count of incidents by severity: critical, warning, and closed. Useful for dashboard-style health checks. Accepts the same filters as list_incidents.
```

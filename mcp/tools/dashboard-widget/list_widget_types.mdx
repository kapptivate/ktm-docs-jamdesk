...
```text
List available dashboard widget types with their constraints, grid sizes, and capabilities. Returns a formatted text guide (not JSON) with layout patterns and widget capabilities. Use before adding widgets to understand what types are available.
```

...
```text
Get a ready-to-fill JSON template for a dashboard widget type. Includes _metadata with grid constraints, valid operations, schema discovery steps, and layout hints.

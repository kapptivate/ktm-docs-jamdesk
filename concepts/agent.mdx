...
For what each agent supports, see the per-family pages under **Agents & Devices**: [Web & API](/agents-devices/web-api), [Smartphone](/agents-devices/smartphone), [SIM](/agents-devices/sim), and [Passive](/agents-devices/passive).

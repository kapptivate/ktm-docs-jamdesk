...
Web agents report their own operational states — see [Statuses](/agents-devices/statuses), including the setup-only "Waiting for Config" state unique to web agents.

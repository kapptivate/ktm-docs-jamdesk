...
description: "Every ktm command, grouped by resource (21 top-level commands)."
sidebarTitle: "Overview"
---

{/* GENERATED FILE — do not edit by hand. Regenerate with: node scripts/generate.mjs */}

The `ktm` CLI groups commands by resource. It exposes **123 commands** across 21 top-level groups. Pick a group below, or use the sidebar.

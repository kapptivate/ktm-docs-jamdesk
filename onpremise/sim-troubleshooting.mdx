...
Either the robot is not connected ([network troubleshooting](/onpremise/network-troubleshooting)), or, if the agent shows available in administration, the robot's clock is out of sync: ask support to check.

...
![The Create new Excel Report modal with the time range, include all products toggle, and the time group dropdown open](/images/excel-report-create.webp)
...
![The CSV reports tab with its list of generated exports](/images/csv-reports.webp)

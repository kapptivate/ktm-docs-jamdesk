...
Create a monitor from the Tests workspace or directly from the Monitors list. A monitor packages a test with a schedule, device assignment, and [alert rules](/monitoring/alerts) so it runs continuously in production.

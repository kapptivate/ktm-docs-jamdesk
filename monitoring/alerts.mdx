...
![The alert template chooser with Threshold, Success rate, and Raw alert cards](/images/alert-types.webp)
...
![The Alert Source section with the bucket selected and the measurement dropdown open over the historical chart](/images/alert-threshold-source.webp)
...
![The threshold alert chart with warning and critical reference lines and the Alert Conditions form below](/images/alert-threshold-conditions.webp)
...
- **Warning** and **Critical**: how many of those points must have failed to reach each severity.

![The success rate alert form with last points to check, the technical error toggle, and warning and critical failure counts](/images/alert-success-rate.webp)
...
![The Restrictions section with the products dropdown open and the notification channels below](/images/alert-restrictions.webp)
...
![The Notifications section of an alert with the Email, Slack, Microsoft Teams, and Webhook channels](/images/alert-notifications.webp)
...
![The Create error exclusion modal with a text pattern in the "If pattern contains" field](/images/alert-error-exclusion.webp)

...
![A dashboard row's menu open, with Edit, favorites, Lock, Duplicate, Move dashboard, Share public link, and Delete](/images/dashboard-actions.webp)
...
![The Add new dashboard form with the name field, bucket selector, and options](/images/dashboard-create.webp)
...
![A dashboard in edit mode with the widget toolbar showing the available visualization types](/images/dashboard-widgets.webp)
...
![The Share dashboard modal on the Public link tab, with the required password field and Generate share link button](/images/dashboard-share.webp)

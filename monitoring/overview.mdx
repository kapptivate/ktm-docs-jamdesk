...
<Columns cols={2}>
  <Card title="Create a monitor" icon="plus" href="/monitoring/create">
    Turn a test into a monitor and set its schedule, devices, and variables.
  </Card>
  <Card title="Monitor analytics & results" icon="chart-line" href="/monitoring/analytics">
    View availability, execution time, and daily failures for a monitor.
  </Card>
</Columns>

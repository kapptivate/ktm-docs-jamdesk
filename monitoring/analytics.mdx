...
| Card | Shows |
|------|-------|
| **Devices** | SIM, Smartphone, or Ethernet agent running the test; browser preset (if applicable) |
...
If a device (SIM, Smartphone, or Ethernet agent) is unavailable or misconfigured, a banner appears above the analytics with troubleshooting steps:
...
<Columns cols={2}>
  <Card title="Monitor incidents" icon="alert-circle" href="/monitoring/incidents">
    Set up alerts and review incident history.
  </Card>
  <Card title="Real-time status" icon="zap" href="/monitoring/realtime-status">
    Track your monitors' current status and recent execution activity.
  </Card>
</Columns>

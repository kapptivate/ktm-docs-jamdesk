...
<Note>
This page covers workspace-wide robot availability alerts. To get notified when a monitor's results degrade, configure notifications per alert in [Alerts](/monitoring/alerts).
</Note>

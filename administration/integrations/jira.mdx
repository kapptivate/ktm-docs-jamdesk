...
<Info>
**Coming in September 2026.** Integrations are not available in Kapptivate yet. This page is published ahead of the release so you can prepare the Atlassian side in advance: everything up to the **Connect** step can be done today.
</Info>
...
<Columns cols={2}>
  <Card title="Slack" icon="comments" href="/administration/integrations/slack">
    ...
    Send the same incidents to a Slack channel

</Card>
  <Card title="Incidents" icon="triangle-exclamation" href="/alerting/incidents">

    See the incidents these tickets come from

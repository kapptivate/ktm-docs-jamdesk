...
<Info>
**Coming in September 2026.** Integrations are not available in Kapptivate yet. This page is published ahead of the release so you can prepare the Microsoft side in advance: everything up to the **Connect** step can be done today.
</Info>
...
<Columns cols={2}>
  <Card title="Slack" icon="comments" href="/administration/integrations/slack">

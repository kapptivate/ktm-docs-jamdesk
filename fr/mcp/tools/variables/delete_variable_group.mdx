...
```text
Sécurisé par défaut : refuse si le groupe contient encore des variables, en les listant. acknowledge=true est requis. force=true contourne la vérification locale de non-vacuité ; le refus propre au backend s'applique toujours.
```

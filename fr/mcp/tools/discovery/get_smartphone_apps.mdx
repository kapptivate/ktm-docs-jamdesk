...
description: "Liste les applications installables sur un smartphone pour créer des tests V2 ou classiques. Copiez `package` vers `starting.app`, l'app vers `meta`."

...
- Un écran, un clavier, une souris et un câble vidéo, branchés au robot comme dans [dépanner un robot Offline](/fr/hardware/network-troubleshooting).

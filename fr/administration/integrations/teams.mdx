...
<Info>
**Disponible en septembre 2026.** Les intégrations ne sont pas encore disponibles dans Kapptivate. Cette page est publiée en avance pour que vous puissiez préparer le côté Microsoft dès maintenant : tout ce qui précède l'étape **Connect** peut être fait aujourd'hui.
</Info>

...
dans cette collection. L'arborescence de collection est la source de référence pour
les reusables : le listage de tests à plat ne filtre pas de manière fiable par kind.

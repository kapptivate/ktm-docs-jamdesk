...
The General tab shows the device's core information (for a SIM: slot, host agent, IMSI, location, network, and usage) and a **Products** section that controls which products may use the device.
